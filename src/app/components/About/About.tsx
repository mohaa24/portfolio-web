...
return (
  <>
    <div className={`${styles.AboutCtr}`}>
      <h1 className=" text-4xl text-left w-full text-white">
        About Me...
      </h1>
      <div className="font-sans text-lg font-medium text-slate-900 dark:text-slate-200">
        <p>
